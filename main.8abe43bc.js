...
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var r=0;r<n.length;r++){var t=n[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}function r(e,r,t){return r&&n(e.prototype,r),t&&n(e,t),e}function t(e){return s(e)||c(e)||i(e)||o()}function o(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function i(e,n){if(e){if("string"==typeof e)return u(e,n);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?u(e,n):void 0}}function c(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function s(e){if(Array.isArray(e))return u(e)}function u(e,n){(null==n||n>e.length)&&(n=e.length);for(var r=0,t=new Array(n);r<n;r++)t[r]=e[r];return t}var a=require("../../node_modules/lodash/random"),l=require("../../node_modules/lodash/isEqual"),d=document.querySelector(".game-field").tBodies[0],f=t(d.querySelectorAll("td")),y=d.rows,m=document.querySelector(".button"),h=document.querySelector(".game-score"),v=+h.innerText,x=document.querySelector(".high-score"),g=+x.innerText,L=document.querySelector(".message-lose"),w=document.querySelector(".message-win"),b=document.querySelector(".message-start"),p=function(){function n(r){e(this,n),this.coords={x:r.cellIndex,y:r.closest("tr").rowIndex},this.HTML=r}return r(n,[{key:"fillCell",value:function(e){this.HTML.classList.add("field-cell--".concat(e)),this.HTML.innerText=e}},{key:"clearCell",value:function(){this.HTML.classList.remove(this.HTML.classList[1]),this.HTML.innerText=""}},{key:"number",get:function(){return+this.HTML.innerText}},{key:"isEmpty",get:function(){return 1===this.HTML.classList.length}}]),n}(),E=function n(r){e(this,n);var t=n.isVerticalKey(r)?"y":"x",o="y"===t?"x":"y",i=n.isAscOrderKey(r)?y[y.length-1].rowIndex:y[0].rowIndex;this.code=r,this.axis=t,this.acrossAxis=o,this.edgeIdx=i};E.arrowKeys=[37,38,39,40],E.isVerticalKey=function(e){return e%2==0},E.isAscOrderKey=function(e){return e>38};var T=f.map(function(e){return new p(e)}),A=new Promise(function(e){m.addEventListener("click",function(){e()})}),k=new Promise(function(e){document.addEventListener("keydown",function(n){E.arrowKeys.includes(n.keyCode)&&e()},{once:!0})});k.then(function(){m.classList.remove("start"),m.classList.add("restart"),m.innerText="Restart"});var C=function(e){var n=new E(e.keyCode);if(E.arrowKeys.includes(n.code)){var r=j(n),t=V(n);j(n),(t.some(function(e){return e})||r)&&I(),q(),M()||S()}};function S(){var e=[];E.arrowKeys.forEach(function(n){var r=new E(n);e=[].concat(t(e),t(V(r,!0)))}),e.every(function(e){return!e})&&L.classList.remove("hidden")}function q(){H().some(function(e){return 2048===e.number})&&(w.classList.remove("hidden"),document.removeEventListener("keydown",C))}function K(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"coords",n=a(1,100)<=90?2:4,r={x:a(0,3),y:a(0,3)};return"cell"===e?n:r}function I(){var e=K(),n=T.find(function(n){var r=n.coords;return+r.x===e.x&&+r.y===e.y});if(n.isEmpty){var r=K("cell");n.fillCell(r)}else M()&&I()}function M(){return T.some(function(e){return e.isEmpty})}function H(){return T.filter(function(e){return!e.isEmpty})}function O(e,n,r,t){var o=e,i=c(o);function c(e){var r=e.coords,t=r.x,o=r.y,i=E.isAscOrderKey(n)?1:-1;return E.isVerticalKey(n)?T.find(function(e){var n=e.coords,r=n.x,c=n.y;return r===t&&c===o+i}):T.find(function(e){var n=e.coords,r=n.x,c=n.y;return r===t+i&&c===o})}for(;i.isEmpty&&i.coords[r]!==t;)i=c(o=i);return i.isEmpty?i:o}function j(e){var n=e.code,r=e.axis,t=e.edgeIdx,o=H().filter(function(e){return e.coords[r]!==t}),i=!1;return o.forEach(function(e){var o=O(e,n,r,t);l(e,o)||(i=!0,o.fillCell(e.number),e.clearCell())}),i}function P(e,n){for(var r=n.code,t=arguments.length>2&&void 0!==arguments[2]&&arguments[2],o=!1,i=E.isAscOrderKey(r)?e.reverse():e,c=0;c<i.length-1;c++)if(i[c].number===i[c+1].number){var s=2*i[c+1].number;if(o=!0,t)return o;i[c].clearCell(),i[c].fillCell(s),i[c+1].clearCell(),v+=s,h.innerText=v,g=g<v?v:g,x.innerText=g,c++}return o}function V(e){var n=arguments.length>1&&void 0!==arguments[1]&&arguments[1],r=_(e),t=[];return r.forEach(function(r){return t.push(P(r,e,n))}),t}function _(e){var n=e.acrossAxis,r=Array.from({length:y.length},function(){return[]});return H().forEach(function(e){r[e.coords[n]].push(e)}),r}A.then(function(){I(),I(),b.classList.add("hidden"),document.addEventListener("keydown",C)}).then(function(){m.addEventListener("click",function(){H().forEach(function(e){return e.clearCell()}),I(),I(),v=0,h.innerText=v,w.classList.add("hidden"),L.classList.add("hidden"),document.addEventListener("keydown",C)})});
},{"../../node_modules/lodash/random":"BDhs","../../node_modules/lodash/isEqual":"R6wa"}]},{},["KIzB"], null)
//# sourceMappingURL=main.8abe43bc.js.map